...
1. On the user page, the **Client health** tab provides more information about client health for all client versions that user is running.
...
1. You can also delete one or all logs collected using the **Delete** option.
...
- Provided Teams client is running, logs may take up to 8 hours before they are fully available for download in Teams Admin center. Please check back after sometime to see the log status. Future enhancements are planned to reduce this time.
